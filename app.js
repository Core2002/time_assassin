var YearPanel = /** @class */ (function () {
    function YearPanel(day_flag) {
        ...
        for (var iw = 0; iw < ld; iw++) {
            for (var id = 0; id < lw; id++) {
    ...
    YearPanel.prototype.print_year_panel_l = function () {
        var res = "";
        res += "--- " + this.day_flag[0] + " ---\n";
        for (var id = 0; id < this.day_arr[0].length; id++) {
            for (var iw = 0; iw < this.day_arr.length; iw++) {
...
function addEle(html) {
    var box = document.getElementById('qwq');
